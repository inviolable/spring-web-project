...
<html>
  ...
  <%
    ...
    String clientSecret = "60BarvJRiH";//애플리케이션 클라이언트 시크릿값";
    ...
    try {
      ...
      if(responseCode==200) {
		...
		String access_token1 = (String)obj.get("access_token");
		out.println("<br>");
		out.println(access_token1);
		session.setAttribute("access_token", access_token1);
		response.sendRedirect("/spring_practice_02/main02");     
